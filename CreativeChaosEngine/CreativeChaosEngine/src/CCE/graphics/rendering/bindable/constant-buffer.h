...
namespace CCE::Graphics
{
	...
	public:
			...
			: slot(_slot)
		{
			...
			g_pDevice->CreateBuffer(&constBufDescription, &subresourceData, &pConstantBuffer);
		}

		virtual void UpdateConstantBuffer(const C& _constant)
		{
			D3D11_MAPPED_SUBRESOURCE mappedResource;
			HRESULT hr = g_pContext->Map(
			...
			g_pContext->Unmap(pConstantBuffer.Get(), 0);
		}
	...
	public:
		...
		{
			IBindable::g_pContext->PSSetConstantBuffers(slot, 1u, pConstantBuffer.GetAddressOf());
		}
	...
	public:
		...
		void DynamicBind() override
		{
			g_pContext->VSSetConstantBuffers(slot, 1u, pConstantBuffer.GetAddressOf());
		}
