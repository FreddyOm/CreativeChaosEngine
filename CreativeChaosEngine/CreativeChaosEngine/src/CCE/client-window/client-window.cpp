...
bool CCE::ClientWindow::OpenWindow(HINSTANCE hInstance, CCE::String winName)
{
	...
	Graphics::InitializeD3D11(hWnd, GetClientWindowWidth(), GetClientWindowHeight());
...
LRESULT CALLBACK ClientWindow::WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_SIZE:
	{
		...
		if (Graphics::g_pContext == NULL) { break; }
		Graphics::OnResize(hwnd, static_cast<UINT>(wParam), width, height);
		break;
	}
	case WM_CLOSE:
	{
